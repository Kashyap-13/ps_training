      ...
      <div class="col-md-6 form-style">
        <form method="post" action="controllers/admin_profile_control.php" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input type="email" class="form-control" id="email_id" name="email_id" placeholder="Email" value= <?php echo $row['email_id']?> >
            </div>
            <div class="col-sm-3">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input type="text" class="form-control" id="user_name" name="user_name" placeholder="User Name" value= <?php echo $row['user_name']?> >
            </div>
            <div class="col-sm-3">
          ...
          <!-- start of form-group for id -->
          <div class="form-group">
            <div class="col-sm-9">
                <input type="hidden" class="form-control" id="user_id" name="user_id" value= <?php echo $id; ?> >
            </div>
          </div>
          <!-- end of form-group for id -->
